...
Files exported from the private repository (66) are listed in MANIFEST.json with sha256 hashes. License status: Apache-2.0 authorized by the owner; third-party terms retained in NOTICE. The two generated substitutes are lib/diligence/host.js and lib/auth.js.
